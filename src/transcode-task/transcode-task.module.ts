...
import { TranscodeTask, TranscodeTaskSchema } from './entities/transcode-task.entity';
import { MongooseModule } from '@nestjs/mongoose';

@Module({
  imports: [MongooseModule.forFeature([{ name: TranscodeTask.name, schema: TranscodeTaskSchema }])],
